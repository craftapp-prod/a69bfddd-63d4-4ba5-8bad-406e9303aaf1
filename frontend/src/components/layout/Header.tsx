...
const Header = () => {
  ...
  return (
    <header className="bg-pink-500 shadow-sm sticky top-0 z-50">
          ...
          <nav className="flex items-center space-x-1 md:space-x-4">
            {isAuthenticated ? (
              ...
              <>
                ...
                <Link
                  href="/register"
                  className="flex items-center bg-white text-primary-600 hover:bg-gray-100 px-3 py-1 md:px-4 md:py-2 rounded-md text-sm font-medium transition"
                >
